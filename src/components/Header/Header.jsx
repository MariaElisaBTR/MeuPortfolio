        ...
        <MainContainer>
            <Container>
                <HeaderWrapper id='header'>
                    <Logo>
                        <img src='/logotipo/logotipo.svg' alt="Maria Elisa" width="70" height="50" />
                    </Logo>
                    <Nav id="nav">
                ...
                <Introducao>
                    <IntroducaoImg src='/img_avatar.webp' alt="Foto de Perfil - Maria Elisa" width="140" />
                    <IntroducaoTitle>Olá! Sou a <strong>Maria Elisa</strong></IntroducaoTitle>
                    <IntroducaoSubtitle>Desenvolvedora<strong>.</strong></IntroducaoSubtitle>
                </Introducao>
                <Contatos>
                    <ContatosLista>
                        <ContatoItem>
                            <ContatoLink href="https://api.whatsapp.com/send?phone=5514998943145" target="_blank" rel="noopener noreferrer">
                                <ContatoImg src="/contato/whatsapp.svg" alt="WhatsApp" width="50" height="50" />
                            </ContatoLink>
                        </ContatoItem>
                        <ContatoItem>
                            <ContatoLink href="mailto:mecoding01@gmail.com?subject=Olá%20Maria Elisa" target="_blank" rel="noopener noreferrer">
                                <ContatoImg src="/contato/email.svg" alt="E-mail" width="50" height="50" />
                            </ContatoLink>
                        </ContatoItem>
                        <ContatoItem>
                            <ContatoLink href="https://github.com/MariaElisaBTR" target="_blank" rel="noopener noreferrer">
                                <ContatoImg src="/contato/github.svg" alt="Github" width="50" height="50" />
                            </ContatoLink>
                        </ContatoItem>
                        <ContatoItem>
                            <ContatoLink href="https://www.linkedin.com/in/mariaelisabtr/" target="_blank" rel="noopener noreferrer">
                                <ContatoImg src="/contato/linkedin.svg" alt="Linkedin" width="50" height="50" />
                            </ContatoLink>
                        </ContatoItem>
                        <ContatoItem>
                            <ContatoLink href="/contato/curriculoMariaElisaBTR.pdf" target="_blank" rel="noopener noreferrer">
